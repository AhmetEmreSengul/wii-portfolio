    ...
    <div>
      ...
      <div className="absolute right-0 top-1/6">
        <div className="w-54 h-40 bg-[#ccced4] border-4 border-[#b9bac2] rounded-l-full flex justify-start items-center">
          <div className="mb-3 size-33 flex items-center justify-center button-shadow rounded-full ml-2 border-3 border-[#5caed4] relative hover:scale-105 hover:border-[#6bc8f3] transition">
