...
const EmailForm = ({
  ...
  return (
    <div className="inset-0 w-screen h-screen bg-black/40 fixed z-1 flex items-center justify-center p-2">
      <motion.form
        action="https://formspree.io/f/xbdrjlwo"
        method="POST"
        className="md:size-120 form-background backdrop-blur-md rounded-2xl flex flex-col gap-5 p-5 justify-center items-center relative"
      ...
      >
        ...
        <IoClose
          className="absolute top-5 right-5 text-5xl p-2"
